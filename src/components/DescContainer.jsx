...
const DescContainer = () => {
    ...
    return (
        <div className="w-full md:w-1/4 text-center ">
            <div className="bg-sky-blue rounded-lg py-3 text-darkBlue">
                <div className="my-4">
                ...
                <div className="mx-auto p-3 rounded-lg">
                    <img className="rounded-lg shadow-xl" src={hits[0].largeImageURL} alt={hits[0].tags} />
                </div>
                <div className="flex flex-nowrap items-center justify-center my-5">
                    <i className={_utils.getIcon(code) + " text-3xl mr-4"}></i>
                    <p className="text-4xl capitalize text-center">{weather[0].description}</p>
                </div>
